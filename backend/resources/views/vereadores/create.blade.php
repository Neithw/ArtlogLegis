                    ...
                    <div class="grid gap-6 p-6 md:grid-cols-2">
                        @if ($usuarioIsRoot)
                            <div>
                                ...
                                <select id="camara_id" name="camara_id" x-model="camaraId" x-on:change="alterarCamara"
                        ...
                        <div>
                            ...
                            <select id="user_id" name="user_id" x-model="userId" x-bind:disabled="!camaraId"
                                ...
                                <template x-for="usuario in usuariosFiltrados" x-bind:key="usuario.id">
                                    ...
                                    <option x-bind:value="String(usuario.id)"
                                        x-text="`${usuario.name} - ${usuario.email}`">
                                    </option>
                                </template>
                            </select>

                            <p x-show="! camaraId" class="mt-2 text-sm text-gray-500">
                                Selecione uma Câmara para visualizar as contas disponíveis.
                            </p>

                            <p x-show="camaraId && usuariosFiltrados.length === 0" class="mt-2 text-sm text-gray-500">
                        ...
                        <div>
                            ...
                            <x-input id="nome_parlamentar" name="nome_parlamentar" type="text"
                                class="mt-1 block w-full" :value="old('nome_parlamentar')" />
                        ...
                        <div>
                            ...
                            <x-input id="email_institucional" name="email_institucional" type="email"
                                class="mt-1 block w-full" value="{{ old('email_institucional') }}" />
                        ...
                        <div>
                            ...
                            <x-input id="telefone_institucional" name="telefone_institucional" type="text"
                                class="mt-1 block w-full" value="{{ old('telefone_institucional') }}" />
                        ...
                        <div class="md:col-span-2">
                            ...
                            <textarea id="biografia" name="biografia" rows="6"
                                class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500">{{ old('biografia') }}</textarea>
