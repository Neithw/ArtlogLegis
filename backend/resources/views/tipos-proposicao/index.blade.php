                ...
                <header
                    ...
                    <div>
                        ...
                        <p class="mt-1 text-sm text-gray-500">
                            Gerencie os tipos de proposição.
                        </p>
                    </div>

                    <div>
                        @can('viewArchived', \App\Models\TipoProposicao::class)
                            <a href="{{ route('tipos-proposicao.arquivados') }}"
                        ...
                        @can('create', \App\Models\TipoProposicao::class)
                            <a href="{{ route('tipos-proposicao.create') }}"
                                ...
                                <tr>
                                    <td colspan="{{ $usuarioIsRoot ? 3 : 2 }}" class="px-6 py-12 text-center">
                                        <p class="text-sm font-medium text-gray-700">
                                            Nenhum tipo de proposição cadastrado.
                                        </p>

                                        <p class="mt-1 text-sm text-gray-500">
                                            Cadastre um tipo para iniciar.
                                        </p>
                                    </td>
                                </tr>
                            @endforelse
