<x-app-layout>
    ...
    <div class="py-8 sm:py-10">
        <div class="mx-auto max-w-4xl px-4 sm:px-6 lg:px-8">
            <form action="{{ route('unidades-tramitacao.store') }}" method="POST" class="space-y-6">
                @csrf
                ...
                <x-ui::card>
                    <header class="border-b border-slate-200 px-4 py-5 sm:px-6 dark:border-neutral-800">
                        ...
                        <p class="mt-1 text-sm text-slate-500 dark:text-neutral-400">
                            Informe a identificação e a função da unidade no fluxo legislativo.
                        </p>
                    </header>

                    @include('unidades-tramitacao._form', [
                        'unidadeTramitacao' => null,
                    ])
                </x-ui::card>
